    ...
    <v-card flat color="#fafafa">
      <v-row>
        <v-col cols="12">
          ...
          <h3 class="mb-3">Identificação</h3>
          <v-divider></v-divider>
                ...
                <v-list-item>
                  <v-list-item-content>
                    ...
                    <div>
                      <v-row>
                        <v-col>
                          <p class="infos">Chip</p>
                        </v-col>
                        <v-col>
                          <p class="respos">{{ animal.chip }}</p>
                        </v-col>
                      </v-row>
                    </div>
                  </v-list-item-content>
                  ...
                  <v-list-item-content>
                    ...
                    <div>
                      <v-row>
                        ...
                        <v-col>
                          <p v-if="animal.castracao === true" class="respos">
                            Sim
                          </p>
                    ...
                    <div>
                      <v-row>
                        <v-col>
                          <p class="infos">Dono</p>
                        </v-col>
                        <v-col>
                          <p class="respos">{{ animal.cliente_nome }}</p>
                        </v-col>
                      </v-row>
                    </div>
                  </v-list-item-content>
          ...
          <h3 class="mt-6 mb-3">Características</h3>
          <v-divider></v-divider>
