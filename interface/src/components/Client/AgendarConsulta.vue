  ...
  <div>
    <v-container class="fill-height">
      <v-row justify="center">
        <v-card class="mt-8" flat color="transparent" width="100%">
              ...
              <v-stepper-items>
                      ...
                      <v-expansion-panels accordion class="mt-2">
                        <v-expansion-panel>
                          <v-expansion-panel-header
                            class="font-weight-bold motivo"
                          >
                            Consulta anual/Vacinação</v-expansion-panel-header
                          >
                          <v-expansion-panel-content>
                            <span class="motivo"
                              >Como os animais envelhecem mais rapidamente que
                              os humanos, a alteração da saúde do seu animal
                              doméstico pode ocorrer em períodos de 6 a 12
                              meses. A avaliação periódica permite detetar essas
                              alterações.
                            </span>

                            <p class="motivo">
                              A vacinação ajuda o sistema imune do seu animal a
                              lutar contra organismos causadores de doenças.
                              Algumas vacinas enquadram-se nos requerimentos
                              legais (como por exemplo, a vacina contra a raiva
                              canina).
                            </p>
                            <v-row justify="end">
                              <v-tooltip right>
                        ...
                        <v-expansion-panel>
                          <v-expansion-panel-header
                            class="font-weight-bold motivo"
                            >Consulta de seguimento</v-expansion-panel-header
                          >
                          <v-expansion-panel-content>
                            <p class="motivo">
                              Agende uma consulta de seguimento para o seu
                              animal.
                            </p>
                            <v-row justify="end">
                              <v-tooltip right>
                        ...
                        <v-expansion-panel>
                          <v-expansion-panel-header
                            class="font-weight-bold motivo"
                            >Procedimentos específicos</v-expansion-panel-header
                          >
                          <v-expansion-panel-content>
                            <v-list flat>
                              <v-list-item-group
                ...
                <v-stepper-content step="3">
                  <v-card class="mb-12" flat>
                    <v-card-title class="font-weight-bold text-uppercase"
                      >Nova consulta para Rubi</v-card-title
                    >
                    <v-card-subtitle>
                      <p class="subtitle">Vacinação</p></v-card-subtitle
                    >
                    <v-card-text>
                      ...
                      <div>
                        ...
                        <span class="black--text">
                          <strong>Sem preferência</strong></span
                        >
                      </div>

                      <div>
                        <span class="text-uppercase"
                          >Algum comentário específico para a sua visita?</span
                        >
